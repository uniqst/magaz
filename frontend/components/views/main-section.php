      ...
      <div class="slider-item">
        <div class="item-box girl" style="background-image: url('img/cat.jpg')">
          <div class="item-box__title">
            <a href="#"><?=Yii::t('app', 'Oksana');?></a>
          </div>
          <div class="item-box__info">
            <span><?=Yii::t('app', 'Age: 28');?></span>
            <span><?=Yii::t('app', 'Russia');?></span>
          </div>
        </div>
      </div>
      <div class="slider-item">
        <div class="item-box service" style="background-image: url('img/cat.jpg')">
          <div class="item-box__title">
            <a href="#"><?=Yii::t('app', 'Service');?></a>
          </div>
          <div class="item-box__info">
            <a href="#"><?=Yii::t('app', 'Doggy Style');?></a>
          </div>
        </div>
      </div>
      <div class="slider-item">
        <div class="item-box story" style="background-image: url('img/cat.jpg')">
          ...
          <div class="item-box__info">
            <a href="#story">
              <?=Yii::t('app', 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Eligendi ipsam nam, itaque tempore consequatur facilis expedita et autem, iusto dolores maiores, similique praesentium beatae culpa enim? Magnam, porro voluptates? Praesentium.');?>
            </a>
          </div>
        </div>
      </div>
